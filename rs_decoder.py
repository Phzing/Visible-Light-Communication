# Credit to https://en.wikiversity.org/wiki/Reed%E2%80%93Solomon_codes_for_coders
...
# print(encoded)
# rs_out = rs_correct_msg(encoded, 32)
# print("WIKI RS OUT", rs_out)
# decoded_str = ""
# for val in rs_out[0]:
#     decoded_str += chr(val)
# print(decoded_str, rs_out[1])